...
export interface LayerConfig {
  id: string;
  type: "text" | "image" | "shape" | "screenshot" | "gradient" | "backgroundColor";
  name: string;
  x: number;
  y: number;
  width: number;
  ...
  locked: boolean;
  opacity: number;
  properties: TextProperties | ImageProperties | ShapeProperties | GradientProperties | BackgroundColorProperties;
  zIndex: number;
}
